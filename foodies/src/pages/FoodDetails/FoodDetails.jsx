            ...
            <div className="container px-4 px-lg-5 my-5">
                <div className="row gx-4 gx-lg-5 align-items-start">
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="food-details-review-card card border-0 shadow-sm rounded-4 p-4">
                            <div className="d-flex justify-content-between align-items-start gap-3 flex-wrap">
                                <div>
                                    <h3 className="h4 mb-2">Customer Reviews</h3>
                            ...
                            <div className="food-details-review-list">
                                {(data.reviews || []).length ? (
